...
const feature = loadFeature(path.join(__dirname, '../features/assign_student_to_class.feature'));
...
defineFeature(feature, (test) => {
    ...
    test('Successfully assign a student to a class', ({ given, and, when, then }) => {
        let requestBody: any = {};
        let response: any = {};
